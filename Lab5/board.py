import pygame
from constants import DARK, LIGHT, BLACK, ROWS, COLS, WHITE, SQUARE_SIZE
...
class Board:
    ...
    def evaluate(self):
        return self.white_left - self.black_left + (self.white_kings * 0.1 - self.black_kings * 0.5)
    ...
    def move(self, piece, row, col):
        ...
        Args:
            piece (Piece): The piece object to be moved.
    ...
    def get_piece(self, row, col):
        ...
        Returns:
            Piece: The piece object at the specified position.
        """
